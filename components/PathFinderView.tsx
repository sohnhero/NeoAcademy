    ...
    useEffect(() => {
        ...
        if (isAnalyzing && analysisStep < ANALYSIS_STEPS.length) {
            ...
            setGeneratedPath({
                ...
                id: `ai-gen-${Date.now()}`,
                title: 'Parcours Architecte Web3 IA',
                description: 'Un parcours sur mesure généré par IA basé sur vos prérequis et objectifs de carrière. Ce parcours met l\'accent sur la sécurité et l\'audit comme demandé.',
                type: 'ai-generated'
            });
        }
